...
{
    private static BoostrapManager instance;

    private void Awake() => instance = this;

    [SerializeField] private string menuName = "JoinLobby";
    ...
    private void Start()
    {
        ...
        joinRequest = Callback<GameLobbyJoinRequested_t>.Create(OnRequestToJoin);
    ...
    private void OnRequestToJoin(GameLobbyJoinRequested_t callback)
    {
